...
public class GruntEnemyShip extends EnemySpaceship {
    ...
    public GruntEnemyShip(double x, double y, int width, int height, Random random) {
    ...
    public void render(Graphics2D graphics) {
        // drawn as a leftward-pointing triangle — no sprite asset needed,
        // matches the style already used for Bullet/PowerUp in this project
